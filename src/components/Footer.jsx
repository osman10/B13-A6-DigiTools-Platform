        ...
        <div className='bg-[#101727] '>
            <div className='section py-[120px] border-b border-[#e5e7eb]'>
                <footer className="footer sm:footer-horizontal text-base-content  p-10 bg-[#101727] text-white">
                    ...
                    <nav>
                        <h6 className="footer-title text-xl ">Socials</h6>
            ...
            <div className='section py-8 flex flex-wrap items-center justify-between'>
                <p className='text-[#fafafa] text-center '>&copy; 2026 Digitools. All rights reserved.</p>
                <div className='flex gap-4 items-center justify-end text-[#fafafa]'>
                    <p>Privacy Policy</p>
