...
const Hero = () => {
    ...
    return (
        <div className='flex justify-between items-center  gap-8 section mt-[60px]'>
            <div className="max-w-[640px]">
                <button className='px-4 py-2 bg-violet-300 rounded-full font-bold flex justify-between items-center gap-2'>
                ...
                <h1 className="text-7xl text-[#101727] font-bold mt-6 leading-20">Supercharge Your Digital Workflow</h1>
